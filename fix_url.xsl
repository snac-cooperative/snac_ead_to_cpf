...
<xsl:stylesheet xmlns:ead="urn:isbn:1-931666-22-9"
    ...
    <!-- 
         Creating urls of EAD records is a separate part of the pipeline. File-to-url conversion data is
         stored in url_xml/*.xml. I think "fix" was chosen in the name because the urls rarely work as
         specified in the EAD <eadid>, so most need to be "fixed".
